require.config({
    paths:{
        "jquery":"http://o7m41tvmg.bkt.clouddn.com/jquery-1.12.4.min"
        // "slidesjs":"http://o7m41tvmg.bkt.clouddn.com/jquery.slides.min"
    },
    shim:{
        'jquery.slides.min':{
            deps:['jquery'],
...
require(['jquery','jquery.slides.min'],function($,slidesjs){
    // $(function(){
        ...
        function popout(e){
            var $current = $(e.currentTarget)
            var index =parseInt($current.attr('data-index'))
            $('.iframe-content.active,.iframe-button.active').removeClass('active')
            $('.iframe-button').eq(index).addClass('active')
            $('.iframe-content').eq(index).addClass('active')
